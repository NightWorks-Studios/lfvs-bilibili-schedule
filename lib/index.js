...
var BilibiliScheduleService = class extends AbstractScheduleService {
  static {
    __name(this, "BilibiliScheduleService");
  }
  platform = "bilibili";
  logPrefix = "bilibili-schedule";
  constructor(ctx, config) {
    super(ctx, "lfvs.bilibili.schedule", config);
    ctx.inject(["webui"], (ctx2) => {
      ctx2.webui.addEntry({
        modulePath: "lfvs-bilibili-schedule",
        baseUrl: import.meta.url,
        source: "../client/index.ts",
        manifest: "../dist/manifest.json"
      }, {
        "bilibili-schedule/status": /* @__PURE__ */ __name(() => {
          const stats = this.lastRoundStats;
          return {
            ...stats,
            load: stats.maxVideoProcess > 0 ? stats.totalProcessed / stats.maxVideoProcess : 0
          };
        }, "bilibili-schedule/status")
      });
    });
  }
};
var apply = /* @__PURE__ */ __name((ctx, config) => {
  ctx.plugin(BilibiliScheduleService, config);
}, "apply");
export {
  BilibiliScheduleService,
  Config,
  apply
};
